...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/ri1n-0HPt/model.json',modelLoaded);
...
function gotResult(error, results) {
  if (error) {
    ...
    {
	    document.getElementById("update_gusture").innerHTML = "&#128076;";
    }
